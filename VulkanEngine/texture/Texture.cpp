...
void Texture::TransitionImageLayout(const VkImage image, const VkFormat format, const VkImageLayout oldLayout, const VkImageLayout newLayout, const VkCommandPool& commandPool)
{
...
void Texture::CopyBufferToImage(const VkBuffer buffer, const VkImage image, const uint32_t width, const uint32_t height, const VkCommandPool& commandPool)
{
    const CommandBuffer commandBuffer{ commandPool };
    commandBuffer.BeginRecording(VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT);
